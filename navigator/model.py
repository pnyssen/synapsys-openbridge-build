...
POST_D007_REPLACEMENTS = [
    ...
    ("Odoo contains only the earlier completed pilot Work Object and lacks the current object identity.",
     "Odoo holds the historical pilot Work Object (id 1) and the authoritative current Work Object identity (id 2, created by the executed D007 correction)."),
    ("Current `WO-NAVIGATOR-...-001` is not registered as operational truth.",
     "Current `WO-NAVIGATOR-...-001` is registered as operational truth (x_ss_work_object_register id 2, receipted)."),
    ("Odoo identity/native relationships and bridge Pattern qualification remain explicit conditions.",
     "Odoo identity/native relationships are resolved (executed D007 correction); bridge Pattern qualification remains the one explicit HOLD condition."),
    ("Odoo execution until explicit bounded D007 release; bridge reuse and Pattern qualification",
     "any further Odoo execution (D007 packet CONSUMED_EXECUTED_ONCE); bridge reuse and Pattern qualification"),
    ("Release and execute the bounded Odoo Work Object / Service / Method correction",
     "Bounded Odoo Work Object / Service / Method correction — executed and receipted"),
    ("The active critical path is the prepared Odoo identity/native relationship correction; link usability is a bounded verification alongside it.",
     "The Odoo identity/native relationship correction is executed and receipted; the active critical path is Steward cold-start acceptance."),
    ("identity/native Service-Method relationships are unresolved, and the inactive one-shot bridge used",
     "identity/native Service-Method relationships are resolved (executed D007 correction), and the inactive one-shot bridge used"),
    ("the active queue has moved to the Odoo identity and relationship correction.",
     "the Odoo identity and relationship correction is executed; the active queue item is Steward acceptance."),
    ("After the bounded Odoo correction and Steward link test, perform final read-only D009 acceptance",
     "The bounded Odoo correction is executed and link-tested; perform final read-only D009 acceptance replay"),
    ("Final acceptance depends on the bounded Odoo correction, link usability confirmation and the remaining explicit Pattern HOLD.",
    ...
    ("current Work Object registration gap remains",
     "authoritative Work Object identity registered (id 2)"),
...
STALE_PROJECTION_MARKERS = [
    ...
    "Release and execute the bounded Odoo",
    "is the prepared Odoo identity", "relationships are unresolved",
    "queue has moved to the Odoo identity",
    "After the bounded Odoo correction and Steward link test",
    "acceptance depends on the bounded Odoo correction",
    "registration gap remains",
